...
|---------------------|--------------------|------|
| | **MCMC methods** | |
| Metropolis-Hastings and Gibbs sampling | [Unit A.1](slides/un_A1.pdf) | [Notebook A.1](https://colab.research.google.com/github/tommasorigon/CompStat/blob/main/notebook/un_A1.ipynb) |
| Rcpp & RcppArmadillo | [Unit A.2](slides/un_A2.pdf) | [Notebook A.2](https://colab.research.google.com/github/tommasorigon/CompStat/blob/main/notebook/un_A2.ipynb) |
